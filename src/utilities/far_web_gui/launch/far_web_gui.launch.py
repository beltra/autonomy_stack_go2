    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                # NOTE: Foxy rosbridge parses these as strings, not string arrays.
                'topics_glob': "['/state_estimation','/far_reach_goal_status','/viz_graph_topic','/viz_graph_topic_filtered','/viz_path_topic','/viz_node_topic','/goal_point','/joy','/planning_attemptable','/update_visibility_graph','/reset_visibility_graph','/web_gui/upload_graph']",
